function [BH,mean_dist] = fun_sc_compute(Bsamp,Tsamp,mean_dist,nbins_theta,nbins_r,r_inner,r_outer,out_vec)
...
r_array_q = nbins_r - r_array_q + 1;
fz=(r_array_q>0&r_array_q<6); % flag all points inside outer boundary
